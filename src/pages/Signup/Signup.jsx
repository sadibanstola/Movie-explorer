    ...
    <div className="relative min-h-screen bg-black text-white">
      ...
      >
        <div className="w-full max-w-md bg-black bg-opacity-75 rounded-lg p-12">
          {step === 1 ? (
            <>
              <h1 className="text-3xl font-bold mb-6">Create a password to start your membership</h1>
              <p className="text-lg mb-6">Just a few more steps and you're done!</p>
            ...
            <>
              <div className="flex items-center mb-6">
                <div className="w-8 h-8 rounded-full bg-red-600 flex items-center justify-center mr-3">1</div>
                <div className="flex-1 h-1 bg-gray-600">
                  <div className="h-full bg-red-600" style={{ width: '100%' }}></div>
                </div>
                <div className="w-8 h-8 rounded-full bg-red-600 flex items-center justify-center mx-3">2</div>
                <div className="flex-1 h-1 bg-gray-600">
                  <div className="h-full bg-gray-600" style={{ width: '0%' }}></div>
                </div>
                <div className="w-8 h-8 rounded-full bg-gray-600 flex items-center justify-center ml-3">3</div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="relative">
                  ...
                  <label 
                    htmlFor="name"
                    className={`absolute left-4 transition-all duration-200 pointer-events-none
                      ${name ? 'text-xs top-2 text-gray-400' : 'top-1/2 -translate-y-1/2 text-gray-400 peer-focus:text-xs peer-focus:top-2'}`}
                  >
                    First name
                  </label>
                </div>
